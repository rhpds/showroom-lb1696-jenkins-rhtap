...
** Project Repo URL: link:https://{developer_cluster_gitlab_user}:{developer_cluster_gitlab_user_password}@gitlab-gitlab.{developer_cluster_openshift_cluster_ingress_domain}/development/secured-app.git[*https://{developer_cluster_gitlab_user}:{developer_cluster_gitlab_user_password}@gitlab-gitlab.{developer_cluster_openshift_cluster_ingress_domain}/development/secured-app.git*,window=_blank]
