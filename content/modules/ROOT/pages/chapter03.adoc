...
** SonarQube URL: link:{sonarqube_url}[*SonarQube*,window=_blank]
...
* Once the *SBOM* has been generated, the next step is to upload it to your organisation’s CycloneDX repository. 
...
image::119_Jenkins_Upload_SBOM_To_CycloneDX[]
...
* "Let's switch back to our pipeline view, and look at the tasks performed by link:glossary.html#acs[*Red Hat Advanced Cluster Security (ACS)*,window=_blank]," you suggest.
