...
* "Correct," you confirm as you open a terminal within your Dev Spaces workspace and run the following command to show *GitSign* configuration: *git config --global --edit*
